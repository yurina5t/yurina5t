...
🕵🏼 Умею анализировать данные в Python, применяю SQL для работы с аналитическими базами данных, работаю с командной строкой и Git, знаю статистику, есть опыт проведения A/A и A/B тестов (дизайн теста, cuped, bootstrap, линеаризация, стратификация), применяю ML-алгоритмы для решения аналитических задач, имею навыки визуализации данных и работы с BI-системами 📊, автоматизирую отчетность на Python в Airflow и строю систему алертов (поиск аномалий) 📈📉.

🏆 Принимаю участие в соревнованиях на ![Kaggle](https://img.shields.io/badge/Kaggle-00BFFF?style=for-the-badge&logo=kaggle&logoColor=white), где в конкурсе по Прогнозированию цен на электроэнергию заняла 🥉 3️⃣ место.
